...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Neura".into(),
            items: vec![
                MenuItem::action("About Neura", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Neura", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Neura", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::neura::OpenProjectTasks),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://neura.dev/docs".into(),
                    },
                ),
                MenuItem::action("Neura Repository", feedback::OpenZedRepo),
                MenuItem::action(
                    "Neura Twitter",
                    super::OpenBrowser {
