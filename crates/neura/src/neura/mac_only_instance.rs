...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Neura Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Neura Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Neura Editor Preview Instance Running",
        ReleaseChannel::Stable => "Neura Editor Stable Instance Running",
    }
}
